            ...
            results: [
              {
                ...
                background_image: "https://media.rawg.io/media/portal-2.jpg",
                short_screenshots: [{ image: "https://media.rawg.io/media/screen1.jpg" }],
              },
            ],
          }),
          { status: 200 }
      ...
      games: [
        {
          ...
          slug: "portal-2",
          rawMetadata: {
            coverUrl: "https://media.rawg.io/media/portal-2.jpg",
            screenshotUrls: ["https://media.rawg.io/media/screen1.jpg"],
          },
        },
      ],
      nextCursor: 1,
